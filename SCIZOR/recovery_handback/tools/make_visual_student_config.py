...
def main() -> None:
    ...
    with cfg.unlocked():
        ...
        # Cache trajectory arrays, but do not duplicate every overlapping
        # 20-step image sequence. This keeps RGB training fast without the
        # hundreds of GiB required by robomimic's full getitem cache.
        cfg.train.hdf5_cache_mode = "all_raw"
