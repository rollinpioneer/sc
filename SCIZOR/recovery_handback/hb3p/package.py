...
ALLOWLIST = (
    ...
    "metrics/diagnosis/hb3p_per_root_diagnosis.csv",
    "metrics/diagnosis/fixed_entry_exit_opportunities.csv",
    "metrics/diagnosis/hb3p_per_root_summary.json",
    "metrics/diagnosis/fixed_entry_exit_summary.json",
    "metrics/diagnosis/exit_diagnosis_decision.json",
    "metrics/diagnosis/HB3P_EXIT_DIAGNOSIS.md",
