...
from curation.suboptimal_classifier.dataset.rlds.oxe.oxe_dataset_configs import ActionEncoding, OXE_DATASET_CONFIGS
from curation.suboptimal_classifier.dataset.rlds.oxe.oxe_dataset_mixes import OXE_NAMED_MIXES
...
from curation.suboptimal_classifier.dataset.rlds.utils.data_utils import NormalizationType
...
def make_oxe_dataset_kwargs(
    ...
    for folder in data_dir_list:
        ...
        if name in dataset:
            chosen_data_dir = folder
            break

    return {"name": name, "data_dir": chosen_data_dir, **dataset_kwargs}
